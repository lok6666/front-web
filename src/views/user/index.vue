    ...
    <div class="user-caontainer">
      ...
      <div class="setting-box">
        <ul v-if="device === 'desktop'" class="left-list">
          ...
          >
          <div :class="`user-icon-${index}`" style="width: 20px; height: 20px;"></div>
        ...
        <div class="setting-box-right">
          <div class="enterprise-service">
              ...
              <img src="../../images/echarts.png"/>
              <div class="enterprise-service-list">
                  <div class="enterprise-service-list-item" v-for="(item, index) in serviceList" :key="index">
                      <div :style="`width: 15px;height: 15px;background: ${item.color}`"></div>
                      {{item.name}}
                  </div>
              </div>
          </div>
          <div class="enterprise-service-manage">
              ...
              <div class="enterprise-service-manage-content">
                <div class="enterprise-service-manage-content-title">服务管家</div>
                <div class="enterprise-service-manage-content-desc" >量身定制，1对1针对性服务，精准解决您的</div>
              </div>
          </div>
      </div>
    </div>
      ...
      .setting-box {
        ...
        .left-list {
          ...
          .left-list-item-active {
            background: linear-gradient(90deg, rgba(16,85,152,0.5) 0%, rgba(74,144,226,0) 100%);
            color: #0052D9;
            line-height: 22px;
            .item-content {
              background: #007fff;
